...
class _FullMessageState extends State<FullMessage> {
    ...
    FirebaseFirestore.instance.collection('posts').get().then((value) {
      value.docs.forEach((element) {
        _post = Post(
            ...
            postUrl: element.get('postUrl'),
            selected: element.get('selected'),
            plus: element.get('plus').toList(),
            neutral: element.get('neutral').toList(),
            minus: element.get('minus').toList(),
  ...
  Widget build(BuildContext context) {
    ...
    // print("_post.toJson(): ${_post.toJson()}");
    // print("_post.toJson()[_selectedCommentFilter.key]: ${_post.toJson()[_selectedCommentFilter.key]}");
