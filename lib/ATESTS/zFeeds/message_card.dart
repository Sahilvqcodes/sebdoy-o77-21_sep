      ...
      child: Padding(
        ...
        child: Container(
          decoration: BoxDecoration(
            ...
            border: Border.all(
                width: 0, color: const Color.fromARGB(255, 167, 167, 167)),
          ...
          child: Column(
            children: [
              ...
              user?.blockList.contains(_post.uid) == false
                  ? Container(
                      child: Column(
                        children: [
                          Row(
                  ...
                  : Container(
                      height: 100,
                      child: Center(child: Text("Blocked User")),
                    ),
            ],
          ),
        ),
